  ...
  build: {
    rollupOptions: {
      input: {
        ...
        singleton: resolve(__dirname, "patterns/Creational/singleton/index.html"),
        observer:  resolve(__dirname, "patterns/Behavioural/observer/index.html"),
        factory:   resolve(__dirname, "patterns/Structural/factory/index.html"),
      },
    },
  },
});
