class TestRunner {
    ...
    public static void main(String[] args) {
        test("create('circle', r) returns non-null", () ->
            assertTrue(ShapeFactory.create("circle", 1) != null, "create() must return non-null"));
        test("create('circle', r) returns a Shape", () ->
            assertTrue(ShapeFactory.create("circle", 1) instanceof Shape, "circle should be a Shape"));
        ...
        test("create('rectangle', w, h) returns a Shape", () ->
            assertTrue(ShapeFactory.create("rectangle", 4, 6) instanceof Shape, "rectangle should be a Shape"));
        ...
        test("create('triangle', b, h) returns a Shape", () ->
            assertTrue(ShapeFactory.create("triangle", 3, 8) instanceof Shape, "triangle should be a Shape"));
